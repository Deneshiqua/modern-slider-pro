...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title ref={ref} className={cn('msp-text-lg msp-font-semibold msp-leading-none msp-tracking-tight', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Description ref={ref} className={cn('msp-text-sm msp-text-muted-foreground', className)} {...props} />
));
